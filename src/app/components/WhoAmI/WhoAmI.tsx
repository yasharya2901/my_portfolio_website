    ...
    return (
        <div className={`m-2`}>
            ...
            <div className={`flex flex-col gap-6 mt-6 text-neutral-300`}>
                <p>
                    {`Currently working at ${currentCompany}, where I architect and develop data-driven solutions that process and analyze large-scale datasets in real-time. My work revolves around creating efficient, scalable systems using modern technologies and cloud-native tools.`}
                </p>
                <p>
